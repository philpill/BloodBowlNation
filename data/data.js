...
var create = `
    ...
    CREATE TABLE IF NOT EXISTS team (id SERIAL PRIMARY KEY, name TEXT NOT NULL UNIQUE, race SERIAL NOT NULL REFERENCES race, manager SERIAL REFERENCES manager, treasury INT NOT NULL CONSTRAINT treasury_positive CHECK (treasury >= 0), createdDate TIMESTAMP WITH TIME ZONE NOT NULL);
